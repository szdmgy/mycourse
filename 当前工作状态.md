...
**目标**：学生端页面适配新功能（继承 base.html + 多附件 + 状态可视化）

需要做的工作（参见 `开发计划.md` 阶段 6）：
- 6.1 `studentCourseList.html` 继承 base.html
- 6.2 `studentTaskList.html` 继承 base.html + 提交状态可视化
- 6.3 `studentSubmit.html` 重构：支持多附件槽位上传
- 6.4 更新上传 JS 逻辑支持多 slot
...
- 时间：2026-02-22
- 内容：完成阶段 5 UI 基础框架（base.html + global.css + login/change_password/profile 适配）
- 最新 commit：`512968a`（阶段 5 代码尚未提交）
